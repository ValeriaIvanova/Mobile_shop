...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings);profileImageView = (CircleImageView) findViewById(R.id.settings_account_image);
    ...
    private void userInfoDisplay(final CircleImageView profileImageView,final EditText fullNameEditText,final EditText userPhoneEditText,final EditText addressEditText) {
        String phone = Prevail.currentOnlineUser.getPhone();
    ...
    private void uploadImage() {
        ...
        if (imageUri != null)
        {
            final StorageReference fileRef = storageProfilePictureRef
                    .child(Prevail.currentOnlineUser.getPhone() + ".WebP");
                    ...
                    return fileRef.getDownloadUrl();
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            if (task.isSuccessful())
                            {
                                ...
                                ref.child(Prevail.currentOnlineUser.getPhone()).updateChildren(userMap);
